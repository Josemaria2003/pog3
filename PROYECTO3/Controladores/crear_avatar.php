...
<body>
    ...
    <div class="container mt-5">
        ...
        <form id="avatarForm" class="mt-4" method="POST" action="javascript:void(0);" onsubmit="crearAvatar()">
                ...
                <div class="d-flex justify-content-around">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="lentesNo">
                            <img src="../../img/sin_lentes.jpg" alt="Sin Lentes" class="img-thumbnail">
                            No
                        </label>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-around">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="animoFeliz">
                            <img src="../../img/animo_feliz.jpg" alt="Feliz" class="img-thumbnail">
                            Feliz
                        </label>
                    </div>
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="animoAmargado">
                            <img src="../../img/animo_amargado.jpg" alt="Amargado" class="img-thumbnail">
                            Amargado
                        </label>
                    </div>
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="animoEmocionado">
                            <img src="../../img/animo_emocionado.jpg" alt="Emocionado" class="img-thumbnail">
                            Emocionado
                        </label>
                    </div>
                </div>
        ...
        <div id="avatarResult" class="mt-4 d-none">
            ...
            <div id="avatarResumen" class="mt-3">
                <!-- Aquí se mostrará el resumen del avatar -->
            </div>
            <form id="comentarioForm" class="mt-3" method="POST" action="../../Controladores/crear_avatar.php">
                ...
                <input type="hidden" name="titulo" id="tituloResumen">
                <input type="hidden" name="comentario" id="comentarioResumen">
                <button type="submit" class="btn btn-primary">Publicar</button>
                <button type="button" class="btn btn-info" onclick="resetForm()">Volver a Crear</button>
            </form>
        </div>
    </div>
    ...
    <script>
        function crearAvatar() {
            ...
            const tonoPiel = formData.get('tonoPiel');
            const colorCabello = formData.get('colorCabello');
            const estiloCabello = formData.get('estiloCabello');
            const lentes = formData.get('lentes');
            const animo = formData.get('animo');
            const titulo = formData.get('titulo');
            const comentario = formData.get('comentario');
            const imagen = 'ruta/a/la/imagen'; // Cambia esto a la ruta de la imagen del avatar

            // Imprimir los datos en la consola
            console.log('Datos del Avatar:');
            console.log('Tono de Piel:', tonoPiel);
            console.log('Color de Cabello:', colorCabello);
            console.log('Estilo de Cabello:', estiloCabello);
            console.log('Usa Lentes:', lentes);
            console.log('Estado de Ánimo:', animo);
            console.log('Título:', titulo);
            console.log('Comentario:', comentario);
            console.log('Imagen:', imagen);

            // Mostrar un resumen del avatar
            document.getElementById('avatarResumen').innerHTML = `
                <p><strong>Tono de Piel:</strong> ${tonoPiel}</p>
                <p><strong>Color de Cabello:</strong> ${colorCabello}</p>
                <p><strong>Estilo de Cabello:</strong> ${estiloCabello}</p>
                <p><strong>Usa Lentes:</strong> ${lentes}</p>
                <p><strong>Estado de Ánimo:</strong> ${animo}</p>
                <p><strong>Título:</strong> ${titulo}</p>
                <p><strong>Comentario:</strong> ${comentario}</p>
                <p><strong>Imagen:</strong> <img src="${imagen}" alt="Avatar"></p>
            `;

            // Rellenar los campos ocultos en el formulario de resumen
            ...
            document.getElementById('tituloResumen').value = titulo;
            document.getElementById('comentarioResumen').value = comentario;
            document.getElementById('imagenAvatar').value = imagen;

            // Mostrar la sección de resumen del avatar
...
ESTE ESTA EN /VISTAS/ENTRAR/crear_avatar.php